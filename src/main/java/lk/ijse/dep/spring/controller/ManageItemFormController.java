...
import lk.ijse.dep.spring.AppInitializer;
...
import lk.ijse.dep.spring.business.custom.impl.ItemBOImpl;
...
public class ManageItemFormController implements Initializable {
    ...
    private ItemBO itemBO = AppInitializer.getApplicationContext().getBean(ItemBOImpl.class);
    ...
    private void loadAllItems() {
        try {
            ...
            ObservableList<ItemTM> items = FXCollections.observableArrayList(allItems);
        ...
        try {
            if (btnSave.getText().equals("Save")) {
                try {
                    ...
                    itemBO.saveItem(txtCode.getText(), txtDescription.getText(), qtyOnHand, BigDecimal.valueOf(unitPrice));
                ...
                ItemTM selectedItem = tblItems.getSelectionModel().getSelectedItem();
                try {
                    itemBO.updateItem(txtDescription.getText(), qtyOnHand, BigDecimal.valueOf(unitPrice), selectedItem.getCode());
                }catch (Throwable t){
