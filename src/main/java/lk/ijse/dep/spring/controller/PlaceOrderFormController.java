...
import lk.ijse.dep.spring.business.custom.impl.CustomerBOImpl;
import lk.ijse.dep.spring.business.custom.impl.OrderBOImpl;
import lk.ijse.dep.spring.util.*;
...
public class PlaceOrderFormController {
    ...
    ItemBO itemBO = AppInitializer.getApplicationContext().getBean(ItemBO.class);
    CustomerBO customerBO = AppInitializer.getApplicationContext().getBean(CustomerBOImpl.class);
    OrderBO orderBO = AppInitializer.getApplicationContext().getBean(OrderBOImpl.class);
