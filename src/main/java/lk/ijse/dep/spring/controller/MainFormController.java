...
public class MainFormController implements Initializable { 
    ...
    /**
     * Initializes the lk.ijse.dep.spring.controller class.
     */
        ...
        if (event.getSource() instanceof ImageView){
            ...
            switch(icon.getId()){
                case "imgCustomer":
                    ...
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.dep.spring.view customers");
                    break;
                case "imgItem":
                    lblMenu.setText("Manage Items");
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.dep.spring.view items");
                    break;
                case "imgOrder":
